...
public class Base {
    ...
    public static void main(String[] args) throws URISyntaxException, IOException {
        ...
        List<Neiro> allNeiro = new ArrayList<>(1000);
        allNeiro.addAll(inputLayer.neiros);
        allNeiro.addAll(hiddenLayer.neiros);
        allNeiro.addAll(outputLayer.neiros);
        Net net = new Net(inputLayer, outputLayer, allNeiro.toArray(new Neiro[0]), Set.of(biasInput, biasHidden));
        net.start(800);
        net.trains(datasTrain, targetsTrain,0.7F, 0.1F,1, 0.01F);
